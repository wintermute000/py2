...
if len(sys.argv) != 4:
    # Exit the script
    sys.exit("Usage: ./generate_rv_config.py <.csv file of parameters> <.txt file of config-template> <device suffix e.g. RTR or SW>")
...
if __name__ == "__main__":
    ...
    for i in config_parameters:
        ...
        site_template = site_template.replace("%sitename%",sitename)
        ...
        site_config = open("RV-DVN2-"+sitename+"-"+device_type+".txt",'w')
