...
if __name__ == '__main__':
    ...
    workbook = xlsxwriter.Workbook(args.device + '.' + args.vsys + "." + "nat.policies.xlsx") # Create Excel spreadsheet.
            ...
            for vsyssection in device.findall("vsys"):
                ...
                for vsys in vsyssection.iterfind(xpath_vsys):
                    for rulebase in vsys.findall("rulebase"):
                        for nat in rulebase.findall("nat"):
                            for rules in nat.findall("rules"):
